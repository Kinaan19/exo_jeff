<template>
  <div id="task">
    <div class="row my-2">
      <div class="col-sm-12">
        <div class="container">
          <draggable v-model="$store.state.todo" :move="onMove" @start="isDragging=true" @end="isDragging=false">
            <transition-group type="transition">
              <div v-for="(todoItem, id) in todoItems" :key="id" class="row bg-dark py-2 my-2">
                <div class="col-sm-12 tasks">
                  <input class="taskInput" type="text" readonly v-model="todoItem.task">
